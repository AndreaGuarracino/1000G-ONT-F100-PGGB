...
sbatch -c 96 -p tux -x tux06 --job-name pggb-$NAME --wrap "$PGGB -i $DIR_BASE/loci/MHC/$NAME.fa.gz -o $DIR_BASE/loci/MHC/pggb.$NAME.p98.s5k.k23             -D /scratch/pggb.$NAME.tmp"
