...
# chr20
$ODGI paths -i $DIR_BASE/graphs_hprc/chr20.pan.fa.a2fb268.4030258.6a1ecc2.smooth.gfa -f | bgzip -@ 48 -l 9 > $DIR_BASE/graphs_hprc/chr20.pan.fa.a2fb268.4030258.6a1ecc2.smooth.fa.gz
samtools faidx $DIR_BASE/graphs_hprc/chr20.pan.fa.a2fb268.4030258.6a1ecc2.smooth.fa.gz
PATH_1000G_FASTA=$DIR_BASE/partitions/1000G-ONT.100x2+4.chr20.30kbp.fa.gz
PATH_HPRC_FASTA=$DIR_BASE/graphs_hprc/chr20.pan.fa.a2fb268.4030258.6a1ecc2.smooth.fa.gz
# Do not take chm13 and grch38 twice
cat \
    <(zcat $PATH_1000G_FASTA) \
    <(samtools faidx $PATH_HPRC_FASTA $(cut -f 1 $PATH_HPRC_FASTA.fai | grep 'chm13\|grch38' -v)) | \
    bgzip -@ 48 -l 9 > $DIR_BASE/1000G-30kbp+HPRC.chr20.fa.gz && samtools faidx $DIR_BASE/1000G-30kbp+HPRC.chr20.fa.gz
